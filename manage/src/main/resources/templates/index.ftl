...
<#-- echarts -->
<script src="${request.contextPath}/public/static/plugins/echarts/echarts.common.min.js"></script>
<script src="${request.contextPath}/public/static/js/index.js"></script>
</body>
</html>
